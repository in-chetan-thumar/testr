...
define('BUTTON_NEXT_ALT', '<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/next-product.png"'.'/>');
define('BUTTON_PREVIOUS_ALT', '<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/prev-product.png"'.'/>');

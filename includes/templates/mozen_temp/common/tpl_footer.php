        	...
        	<h3>Important Links</h3>
            	<div class="custom mj-grid24 mj-dotted">
                    <ul class="footer-bullet">
                        <li><a href="<?php echo zen_href_link("conditions"); ?>">Terms &amp; condition</a></li>
                        <li><a href="<?php echo zen_href_link(FILENAME_PRIVACY); ?>">Privacy Policy</a></li>
                        <li><a href="<?php echo zen_href_link("privacy"); ?>">Refund policy</a></li>
                        <li><a href="<?php echo zen_href_link("site_map"); ?>">Sitemap</a></li>
                        <li><a href="<?php echo zen_href_link("shippinginfo"); ?>">Shipping & Returns</a></li>
						<li><a href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=' . '16',  'NONSSL'); ?>"> Disclaimer </a></li>
                    </ul>
				</div>
        </div>
		<div class="moduletable mj-grid24 mj-dotted">
        	<h3>Extra</h3>
            	<div class="custom mj-grid24 mj-dotted">
                    <ul class="footer-bullet">
                        <li><a href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=' . '21',  'NONSSL');  ?>">Certificate of Authenticity</a></li>
						<li><a href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=' . '23',  'NONSSL');  ?>">Customer Feedback</a></li>
						<li><a href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=' . '18',  'NONSSL');  ?>">Festival Calender</a></li>
						<li><a href="<?php echo zen_href_link(FILENAME_EZPAGES, 'id=' . '17',  'NONSSL');  ?>">Exhibitions</a></li>
						<li><a href="<?php echo zen_href_link("distributors"); ?>" >Distributors</a></li>
						<li><a href="<?php echo zen_href_link("supply2us"); ?>" >Supply to Us</a></li>
						<li><a href="<?php echo zen_href_link('index.php?main_page=recomendation', '', 'NONSSL', true, true, true); ?>" >Free Recommendation</a></li>
                    </ul>
				</div>
        </div>
        <div class="moduletable mj-grid24 mj-dotted">

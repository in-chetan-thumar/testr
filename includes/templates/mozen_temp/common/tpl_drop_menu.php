...
<script type="text/javascript">
        ...
        ?>
                    ...
                    <li id='contact_us'><a href="<?php echo zen_href_link("shippinginfo"); ?>">Shipping & Returns</a></li>
					<li id='contact_us'><a href="<?php echo zen_href_link("page&id=15"); ?>"><?php echo "Payment Option"; ?></a></li>

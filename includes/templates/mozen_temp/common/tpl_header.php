            ...
            <div class="mj-grid40 mj-rspace"> <!--Top bar Links on the Right-->
            	<ul class="menu">
					<?php if ($_SESSION['customer_id']) { ?>
                        ...
                        <li><a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL'); ?>"><?php echo BOX_HEADING_SHOPPING_CART; ?></a>
						</li>
					<?php } 
					else 
					{
					...
					{?>
					<li><a><?php echo $currencies->format($_SESSION['cart']->show_total());?></a></li>
					<li><a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL'); ?>"><?php echo BOX_HEADING_SHOPPING_CART; ?></a></li>

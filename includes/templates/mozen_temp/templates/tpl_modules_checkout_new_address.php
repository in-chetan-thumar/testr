...
<fieldset>
<span class="title"><?php echo TITLE_PLEASE_SELECT; ?></span>
...
<?php echo zen_get_country_list('zone_country_id', $selected_country, 'id="country" style="width:27.6%" ' . ($flag_show_pulldown_states == true ? 

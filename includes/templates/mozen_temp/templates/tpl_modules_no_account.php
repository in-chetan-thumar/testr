...
?>
<br class="clearBoth" />
<?php echo zen_draw_checkbox_field('newsletter', '1', $_SESSION['newsletter'], 'id="newsletter-checkbox"') . '<label class="checkboxLabel" for="newsletter-checkbox">' . ENTRY_NEWSLETTER . '</label>' . (zen_not_null(ENTRY_NEWSLETTER_TEXT) ? '<span class="alert">' . ENTRY_NEWSLETTER_TEXT . '</span>': ''); ?>
<?php } ?>
<?php if (!isset($_GET['type']) || $_GET['type'] != 'free_virtual') { ?>
<?php 
...
<?php echo zen_draw_input_field('dob', $_SESSION['dob'], 'id="dob"') . (zen_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '<span class="alert">' . '*<br> (eg. 05/21/1970)' . '</span>': ''); ?>
<br class="clearBoth" />
</fieldset>
<br class="clearBoth" />
<?php

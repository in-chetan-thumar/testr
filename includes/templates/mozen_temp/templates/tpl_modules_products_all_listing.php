...
?>
          <tr class="<?php echo ((int)($row_counter/2)==($row_counter/2)) ? 'productListing-alleven' : 'productListing-allodd'; ?>">
            <td width="<?php echo IMAGE_PRODUCT_ALL_LISTING_WIDTH + 10; ?>" valign="top" class="main newproduct-mainleft" align="center">
              <?php
			...
			$disp_sort_order1 = $db->Execute("select configuration_key, configuration_value from " . TABLE_CONFIGURATION . " where configuration_group_id='" . $group_id . "' and (configuration_value >= 1000 and configuration_value <= 1999) order by LPAD(configuration_value,11,0)");
			 ...
			 while (!$disp_sort_order1->EOF) {
				  ...
				  if ($disp_sort_order1->fields['configuration_key'] == 'PRODUCT_ALL_BUY_NOW') {
                    ?><div class="mj-productnewprice"><?php echo $display_products_button; ?></div><?php
                  }
				  if ($disp_sort_order1->fields['configuration_key'] == 'PRODUCT_ALL_LIST_QUANTITY') {

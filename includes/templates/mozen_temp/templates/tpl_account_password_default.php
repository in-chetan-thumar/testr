...
<label class="inputLabel" for="password-current"><?php echo ENTRY_PASSWORD_CURRENT; ?> <?php echo zen_not_null(ENTRY_PASSWORD_CURRENT_TEXT) ? '<span class="alert">' . ENTRY_PASSWORD_CURRENT_TEXT . '</span>': ''; ?></label>

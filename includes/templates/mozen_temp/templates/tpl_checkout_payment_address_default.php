...
<div class="review_box">
	<div class="product_info_left">
        <span class="title"><?php echo TITLE_PAYMENT_ADDRESS; ?></span>
        <address><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['billto'], true, ' ', '<br />'); ?></address>
	</div>
    
    <div class="product_info_right">
    	<div class="mj-boxcontent"><?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?></div>
    </div>
</div> <!--review_box ends -->
...
<div class="review_box">
<span class="title"><?php echo TABLE_HEADING_NEW_PAYMENT_ADDRESS; ?></span>
<?php

...
<fieldset>
<h4 class="acc_trigger"><a href="#"><?php echo TABLE_HEADING_ADDRESS_DETAILS; ?></a></h4>
...
<?php } ?>
<label class="inputLabel" for="state" id="stateLabel"><?php echo $state_field_label; ?> <?php echo zen_not_null(ENTRY_STATE_TEXT) ? '<span class="alert">' . ENTRY_STATE_TEXT . '</span>': ''; ?></label>
<?php
...
<?php echo zen_get_country_list('zone_country_id', $selected_country, 'id="country" class="inputlogin" style="width:27.6%" ' . ($flag_show_pulldown_states == true ? 'onchange="update_zone(this.form);"' : '')) ; ?>
<br class="clearBoth" />
</div>
</fieldset>
...
?>
<fieldset>
<h4 class="acc_trigger"><a href="#"><?php echo CATEGORY_COMPANY; ?></a></h4>
<div class="acc_container">
<label class="inputLabel" for="company"><?php echo ENTRY_COMPANY; ?></label>
<?php echo zen_draw_input_field('company', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_company', '40') . ' id="company"  class="inputlogin"') . (zen_not_null(ENTRY_COMPANY_TEXT) ? '<span class="alert">' . ENTRY_COMPANY_TEXT . '</span>': ''); ?>
</div>
</fieldset>
<?php
  }
...
<fieldset>
<h4 class="acc_trigger"><a href="#"><?php echo TABLE_HEADING_PHONE_FAX_DETAILS; ?></a></h4>
<div class="acc_container">
...
<h4 class="acc_trigger"><a href="#"><?php echo TABLE_HEADING_DATE_OF_BIRTH; ?></a></h4>
<div class="acc_container">
<label class="inputLabel" for="dob"><?php echo ENTRY_DATE_OF_BIRTH; ?> <?php echo zen_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '<span class="alert">' . ENTRY_DATE_OF_BIRTH_TEXT . '</span>': ''; ?></label>
...
<fieldset>
<h4 class="acc_trigger"><a href="#"><?php echo TABLE_HEADING_LOGIN_DETAILS; ?></a></h4>
<div class="acc_container">
...
?>
<label class="inputLabel" for="nickname"><?php echo ENTRY_NICK; ?> <?php echo zen_not_null(ENTRY_NICK_TEXT) ? '<span class="alert">' . ENTRY_NICK_TEXT . '</span>': ''; ?></label>
...
<label class="inputLabel" for="password-confirm"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?> <?php echo zen_not_null(ENTRY_PASSOWRD_CONFIRMATION_TEXT) ? '<span class="alert">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>': ''; ?></label>
...
<fieldset>
<h4 class="acc_trigger"><a href="#"><?php echo ENTRY_EMAIL_PREFERENCE; ?></a></h4>
<div class="acc_container">
<?php
...
<h4 class="acc_trigger"><a href="#"><?php echo TABLE_HEADING_REFERRAL_DETAILS; ?></a></h4>
<div class="acc_container">

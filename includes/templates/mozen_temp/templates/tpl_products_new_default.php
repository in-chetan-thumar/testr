...
<div id="newProductsDefaultListingTopLinks" class="navSplitPagesLinks forward mj-pagination"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></div>
...
?>
  ...
  <div id="newProductsDefaultListingBottomLinks" class="navSplitPagesLinks forward mj-pagination"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></div>
<?php
  }
?>
<br class="clearBoth" />

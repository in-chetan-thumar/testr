...
<?php if (SHOW_ACCOUNT_LINKS_ON_SITE_MAP=='Yes') { ?>
        <li><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '" rel="nofollow">' . PAGE_ACCOUNT . '</a>'; ?>
        <ul>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL') . '" rel="nofollow">' . PAGE_ACCOUNT_EDIT . '</a>'; ?></li>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '" rel="nofollow">' . PAGE_ADDRESS_BOOK . '</a>'; ?></li>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '" rel="nofollow">' . PAGE_ACCOUNT_HISTORY . '</a>'; ?></li>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL') . '" rel="nofollow">' . PAGE_ACCOUNT_NOTIFICATIONS . '</a>'; ?></li>
        </ul></li>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_SHOPPING_CART) . '" rel="nofollow">' . PAGE_SHOPPING_CART . '</a>'; ?></li>
          <li><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" rel="nofollow">' . PAGE_CHECKOUT_SHIPPING . '</a>'; ?></li>
<?php } //endif ?>
<ul>
         <li><?php  echo '<a href="' . zen_href_link(FILENAME_ADVANCED_SEARCH) . '" rel="nofollow">' . PAGE_ADVANCED_SEARCH . '</a>'; ?></li>
...
<?php if (DEFINE_PRIVACY_STATUS <= 1) {?>
		    <li><?php echo '<a href="' . zen_href_link(FILENAME_PRIVACY) . '" rel="nofollow">' . BOX_INFORMATION_PRIVACY . '</a>'; ?></li>
            <?php } ?>
<?php if (DEFINE_CONDITIONS_STATUS <= 1) {?>			
            <li><?php echo '<a href="' . zen_href_link(FILENAME_CONDITIONS) . '" rel="nofollow">' . BOX_INFORMATION_CONDITIONS . '</a>'; ?></li>
            <?php } ?>
<?php if (DEFINE_SHIPPINGINFO_STATUS <= 1) {?>
            <li><?php echo '<a href="' . zen_href_link(FILENAME_SHIPPING) . '" rel="nofollow">' . BOX_INFORMATION_SHIPPING . '</a>'; ?></li>
            <?php } ?>
<?php if (DEFINE_CONTACT_US_STATUS <= 1) {?>
            <li><?php echo '<a href="' . zen_href_link(FILENAME_CONTACT_US) . '" rel="nofollow">' . BOX_INFORMATION_CONTACT . '</a>'; ?></li>
            <?php } ?>
...
<?php } ?> 
            ...
            <li><?php echo '<a href="' . zen_href_link(FILENAME_GV_FAQ) . '" rel="nofollow">' . BOX_INFORMATION_GV . '</a>'; ?></li>
            <?php } ?>
            <?php if (MODULE_ORDER_TOTAL_COUPON_STATUS == 'true') { ?>
            <li><?php echo '<a href="' . zen_href_link(FILENAME_DISCOUNT_COUPON) . '" rel="nofollow">' . BOX_INFORMATION_DISCOUNT_COUPONS . '</a>'; ?></li>
            <?php } ?>
            <?php if (SHOW_NEWSLETTER_UNSUBSCRIBE_LINK == 'true') { ?>
            <li><?php echo '<a href="' . zen_href_link(FILENAME_UNSUBSCRIBE) . '" rel="nofollow">' . BOX_INFORMATION_UNSUBSCRIBE . '</a>'; ?></li>
            <?php } ?>

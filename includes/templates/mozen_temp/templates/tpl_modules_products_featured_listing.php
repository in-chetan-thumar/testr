...
//            $how_many++;
            $link = TEXT_PRODUCT_FEATURED_LISTING_MULTIPLE_ADD_TO_CART . "<input type=\"text\" name=\"products_id[" . $featured_products->fields['products_id'] . "]\" value=\"0\" size=\"4\" /><br />" ;
          } else {
...
?>
          <tr>
            <td width="<?php echo IMAGE_FEATURED_PRODUCTS_LISTING_WIDTH + 10; ?>" valign="top" class="main newproduct-mainleft" align="center">
              <?php
            ...
            <td class="mj-newproductprice">
			 ...
			 while (!$disp_sort_order1->EOF) {
				  ...
				  if ($disp_sort_order1->fields['configuration_key'] == 'PRODUCT_FEATURED_BUY_NOW') {
                    ?><div class="mj-productnewprice"><?php echo $display_products_button; ?></div><?php
                  }
				  if ($disp_sort_order1->fields['configuration_key'] == 'PRODUCT_FEATURED_LIST_QUANTITY') {

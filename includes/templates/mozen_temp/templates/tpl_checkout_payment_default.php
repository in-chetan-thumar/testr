...
<h3 id="checkoutPaymentHeading"><?php //echo HEADING_TITLE; ?><span class="mj-step1">STEP1</span> &nbsp; <span class="mj-step">STEP2</span> &nbsp; <span class="mj-step1">STEP3</span></h3>
...
<div class="review_box">
	...
	<span class="title"><?php echo TITLE_BILLING_ADDRESS; ?></span>
    ...
    <div class="product_info_right">
		<div class="floatingBox important forward mj-boxcontent"><?php echo TEXT_SELECTED_BILLING_DESTINATION; ?></div>
    		<?php if (MAX_ADDRESS_BOOK_ENTRIES >= 2) { ?>
			
        <div class="buttonRow forward change_add"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">' . zen_image_button(
			BUTTON_IMAGE_CHANGE_ADDRESS, BUTTON_CHANGE_ADDRESS_ALT) . '</a>'; ?></div>
		<?php } ?>
...
<?php // ** BEGIN PAYPAL EXPRESS CHECKOUT **
      ...
      // ** END PAYPAL EXPRESS CHECKOUT ** ?>
	<div class="review_box">
        <span class="title"><?php echo TEXT_YOUR_TOTAL; ?></span>
        <?php
...
?>
<div class="mj-boxhint"><?php echo zen_output_string_protected($_GET['credit_class_error']); ?></div>
...
?>
<div class="review_box">
		<span class="title"><?php echo $selection[$i]['module']; ?></span>
...
<div class="review_box">
		<span class="title"><?php echo TABLE_HEADING_PAYMENT_METHOD; ?></span>

...
<label class="inputLabel" for="telephone"><?php echo ENTRY_TELEPHONE_NUMBER; ?> <?php echo zen_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span class="alert">' . ENTRY_FIRST_NAME_TEXT . '</span>': ''; ?></label>

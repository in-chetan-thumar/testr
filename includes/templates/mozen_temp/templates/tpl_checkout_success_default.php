...
<?php /*?><h1 id="checkoutSuccessHeading"><?php echo HEADING_TITLE; ?></h1><?php */?>
<div class="review_box">
	<div class="product_info_left">
		<div class="mj-boxdownload">
    ...
    <div class="product_info_right">
        ...
        <div class="mj-boxcontent">
            ...
            <div class="buttonRow forward"><a href="<?php echo zen_href_link(FILENAME_LOGOFF, '', 'SSL'); ?>"><?php echo zen_image_button(BUTTON_IMAGE_LOG_OFF ,
				 BUTTON_LOG_OFF_ALT); ?></a></div>
        </div>
    </div>
</div>
<!--eof logoff-->
...
<h3 id="checkoutSuccessThanks" class="centeredContent"></h3>
</div>
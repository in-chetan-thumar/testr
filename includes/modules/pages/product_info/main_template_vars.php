 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  pd.products_description, pd.products_description1, pd.product_small_desc, p.products_model,
...
// if review must be approved or disabled do not show review
  ...
  $products_description1 = (!preg_match('/(<br|<p|<div|<dd|<li|<span)/i', $product_info->fields['products_description1']) ? nl2br($product_info->fields['products_description1']) : $product_info->fields['products_description1']);
  
  $product_small_description = (!preg_match('/(<br|<p|<div|<dd|<li|<span)/i', $product_info->fields['product_small_desc']) ? nl2br($product_info->fields['product_small_desc']) : $product_info->fields['product_small_desc']);

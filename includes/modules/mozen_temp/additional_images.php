...
//  $flag_has_large = file_exists($products_image_large);
	...
	if (ZEN_LIGHTBOX_STATUS == 'true') {
	  ?>
       <a href="<?php echo zen_lightbox($products_image_large, addslashes($products_name), LARGE_IMAGE_WIDTH, LARGE_IMAGE_HEIGHT); ?>" rel="useZoom: 'zoom01', smallImage: '<?php echo zen_lightbox($products_image_large, addslashes($products_name), LARGE_IMAGE_WIDTH, LARGE_IMAGE_HEIGHT); ?>'" class="cloud-zoom-gallery">
      <?php
	  echo $thumb_slashes;
	  ?>
</a> 
<?php
    ...
    $noscript_link = '<noscript>' . ($flag_display_large ? '<a href="' . zen_href_link(FILENAME_POPUP_IMAGE_ADDITIONAL, 'pID=' . $_GET['products_id'] . '&pic=' . $i . '&products_image_large_additional=' . $products_image_large) . '" target="_blank">' . $thumb_regular . '<br /><span class="imgLinkAdditional">' . /* TEXT_CLICK_TO_ENLARGE . */
	'</span></a>' : $thumb_regular ) . '</noscript>';

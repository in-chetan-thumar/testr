...
if ($num_products_count > 0) {
  ...
  while (!$specials_index->EOF) {
	...
	$products_description = zen_trunc_string(zen_clean_html(stripslashes(zen_get_product_small_desc($specials_index->fields['products_id'], $_SESSION['languages_id']))), PRODUCT_LIST_DESCRIPTION); //To Display Product Desc 

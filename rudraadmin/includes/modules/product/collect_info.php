...
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    if (isset($_GET['pID']) && empty($_POST)) {
      $product = $db->Execute("select pd.products_name, pd.products_description, pd.products_description1, pd.product_small_desc, pd.products_url,
	  ...
	  $product_small_desc = $_POST['product_small_desc'];
...
?>
          <tr>
            ...
            <td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main" width="25" valign="top"><?php echo zen_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>&nbsp;</td>
                <td class="main" width="100%"><?php echo zen_draw_textarea_field('products_description1[' . $languages[$i]['id'] . ']', 'soft', '100%', '30', htmlspecialchars((isset($products_description1[$languages[$i]['id']])) ? stripslashes($products_description1[$languages[$i]['id']]) : zen_get_products_description1($pInfo->products_id, $languages[$i]['id']), ENT_COMPAT, CHARSET, TRUE)); //,'id="'.'products_description' . $languages[$i]['id'] . '"'); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
...
?>
          <tr>
            <td class="main" valign="top"><?php if ($i == 0) echo 'Product small description'; ?></td>
            <td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main" width="25" valign="top"><?php echo zen_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>&nbsp;</td>
                <td class="main" width="100%"><?php echo zen_draw_textarea_field('product_small_desc[' . $languages[$i]['id'] . ']', 'soft', '100%', '30', htmlspecialchars((isset($product_small_desc[$languages[$i]['id']])) ? stripslashes($product_small_desc[$languages[$i]['id']]) : zen_get_product_small_desc($pInfo->products_id, $languages[$i]['id']), ENT_COMPAT, CHARSET, TRUE)); //,'id="'.'product_small_desc' . $languages[$i]['id'] . '"'); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
